		...
		<script type="text/javascript">
				$(function(){
					...
					if(word!=""){
						...
						if($("#search").val()!="ab_content"){
							if($("#search").val()=="ab_title"){
					...
					$(".goDetail").click(function(){
						...
						$("#detailForm").attr({
							"method":"get",
							"action":"/client/board/adminboard/adminboardDetail.do"
						});
						$("#detailForm").submit();
					});
				...
				function goPage(){
					...
					$("#f_search").attr({
						"method":"get",
						"action":"/client/board/adminboard/adminboardList.do"
					});
					$("#f_search").submit();
				}
		</script>
	<body>
		<div class="container-fluid">
		         <form id="detailForm" name="detailForm">
					<input type="hidden" name="ab_no" id="ab_no"/>
					...
					<tbody id="list">
						...
						<c:choose>
							<c:when test="${not empty adminboardList }">
								<c:forEach var="ab" items="${adminboardList }">
									<tr class="tac" data-num="${ab.ab_no }">
										<td>${ab.ab_no }</td>
										<td>${ab.ab_type }</td>
										<td class="goDetail">${ab.ab_title }</td>
										<td>${ab.ad_id }</td>
										<td>${ab.ab_date }</td>
									</tr>
								</c:forEach>
